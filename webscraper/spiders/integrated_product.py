...
class IntegratedProductSpider(scrapy.Spider):
    name = "integrated_product"
    allowed_domains = ["phoenixtapware.com.au"]

    def start_requests(self):
        """Start by crawling product listing pages"""
    ...
    def parse_listing(self, response):
        ...
        # Make requests to each product page
    ...
    def parse_product(self, response):
        ...
        self.logger.info(f"Scraped product: {title} - {sku}")
        yield product_data